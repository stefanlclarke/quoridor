...
import copy
import time
from quoridor_env.game.game_helper_functions import move_piece, place_wall_with_check, check_win, get_legal_moves, \
    flip_board
from quoridor_env.game.graph_search import BoardGraph
from quoridor_env.game.printing import get_printable_board
from quoridor_env.game.move_reformatter import move_reformatter, unformatted_move_to_index
...
class Quoridor:
    ...
    def reset_board(self, random_positions=False):
